    ...
    <AppShell mode="canvas" onModeChange={handleModeChange}>
      ...
      {showLinkModal && (
        <>
          ...
          />
          <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-50 bg-white rounded-2xl shadow-lift border border-gray-200 p-4 w-96 animate-scale-in flex flex-col max-h-[90vh]">
            <h2 className="text-lg font-bold text-foreground mb-3 flex-shrink-0">
              Add Link
            </h2>
            <div className="space-y-2 flex-1 overflow-y-auto">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-accent focus:border-transparent calm-transition"
                  autoFocus
                />
              </div>
              <div>
            ...
            <div className="flex gap-3 justify-end pt-3 mt-2 flex-shrink-0 border-t border-gray-200">
              <button
                onClick={() => setShowLinkModal(false)}
                className="px-4 py-2 text-sm text-gray-700 border border-gray-300 rounded-lg hover:bg-gray-50 calm-transition font-medium"
              >
                Cancel
              </button>
              <button
                onClick={saveLinkNode}
                className="px-4 py-2 text-sm bg-accent text-white rounded-lg hover:bg-accent-dark calm-transition font-medium shadow-soft"
              >
                Save
              </button>
            </div>
      ...
      {showImageModal && (
        <>
          ...
          />
          <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-50 bg-white rounded-2xl shadow-lift border border-gray-200 p-4 w-96 max-h-[90vh] animate-scale-in flex flex-col">
            <h2 className="text-2xl font-bold text-foreground mb-4 flex-shrink-0">
              Add Image
            </h2>
            <div className="space-y-3 flex-1 overflow-y-auto">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-accent focus:border-transparent calm-transition"
                  autoFocus
                />
              </div>
            ...
            <div className="flex gap-3 justify-end pt-3 mt-2 flex-shrink-0 border-t border-gray-200">
              ...
              <button
                ...
                className="px-4 py-2 text-sm bg-accent text-white rounded-lg hover:bg-accent-dark calm-transition font-medium shadow-soft disabled:opacity-50 disabled:cursor-not-allowed"
                disabled={!imageUrl}
              >
                Save
              </button>
